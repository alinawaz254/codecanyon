            ...
            <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center pull-right">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul aria-labelledby="notifications" class="dropdown-menu notification">
                        ...
                        <li>
                            <a rel="nofollow" href="notes.php" class="dropdown-item all-notifications text-center"><?php _e("View All Notes"); ?></a>
                        </li>
                    </ul>
                </li>
                <!-- End Notifications -->
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul aria-labelledby="user" class="user-size dropdown-menu">
                        <li class="welcome">
                            ...
                            <a href="edit_profile.php?user_id=<?php echo $_SESSION['user_id']; ?>" class="edit-profil"><i class="la la-gear"></i></a>
                        ...
                        <li>
                            <a class="dropdown-item" href="messages.php">
                                <?php _e("Messages"); ?> <span class="nb-new badge-rounded info badge-rounded-small"><?php $message_obj->unread_count(); ?></span>
                            </a>
                        </li>
                        <li>
                        ...
                        <?php endif; ?>
                        <li>
                            <a class="dropdown-item" href="edit_profile.php?user_id=<?php echo $_SESSION['user_id']; ?>">
                                <?php _e("Edit Profile"); ?>
                            </a>
                        </li>
                        <li><a rel="nofollow" href="dashboard.php?logout=1" 
